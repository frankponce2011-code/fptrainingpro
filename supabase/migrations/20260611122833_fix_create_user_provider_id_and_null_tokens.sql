...
-- 1. Corregir identidades existentes con provider_id incorrecto (UUID en vez de email)
...
-- 2. Recrear la funcion create_user con provider_id correcto
...
BEGIN
  ...
  -- provider_id DEBE ser el email para que GoTrue pueda autenticar
